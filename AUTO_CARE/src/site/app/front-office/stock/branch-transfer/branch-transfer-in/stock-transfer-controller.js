(function () {
    angular.module("stockTransferBranchInModule", ['ui.bootstrap']);
    angular.module("stockTransferBranchInModule")
            .controller("stockTransferBranchInController", function ($scope, $filter,stockTransferBranchInModel, $timeout, Notification, ConfirmPane) {
                $scope.model = new stockTransferBranchInModel();
                $scope.ui = {};
...
//                    $scope.model.edit(indexNo);
                ...
                $scope.ui.getPendingTransferOrders = function (branch,store) {
                    $scope.model.getPendingTransferOrders(branch,store);
                };
...
//                    $scope.model.delete(indexNo);
                ...
                $scope.ui.save = function () {
                    ConfirmPane.primaryConfirm("Complete Stock Transfer Order Request !")
                            .confirm(function () {
                                $scope.model.saveStockTransferIn()
                                        .then(function () {
                                            $scope.ui.mode = "IDEAL";
//                                            $scope.model.clear();
